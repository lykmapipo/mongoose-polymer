...
describe('Polymer morphOne', function() {
    ...
    it('should be able to set owned model instance', function(done) {
    ...
    it('should be able to find owned model instance', function(done) {
        /*jshint camelcase:false*/
        var user = new User();
        var name = faker.lorem.words(1)[0];
    ...
    it('should be able to remove owned model instance', function(done) {
        /*jshint camelcase:false*/
        var user = new User();
